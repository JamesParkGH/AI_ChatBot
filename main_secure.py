...
def main():
    ...
    api_key = os.getenv('OPENROUTER_API_KEY', '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')
    
    if not api_key or api_key == 'your_api_key_here':
        print("❌ Error: No valid API key found!")
        print("Please either:")
        print("1. Set the OPENROUTER_API_KEY environment variable")
        print("2. Or update the API key in the code")
        return
